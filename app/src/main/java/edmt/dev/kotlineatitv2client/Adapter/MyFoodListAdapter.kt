package edmt.dev.kotlineatitv2client.Adapter
...
import edmt.dev.kotlineatitv2client.Callback.IRecyclerItemClickListener
...
import edmt.dev.kotlineatitv2client.EventBus.CategoryClick
import edmt.dev.kotlineatitv2client.EventBus.CountCartEvent
import edmt.dev.kotlineatitv2client.EventBus.FoodItemClick
            ...
            cartDataSource.getItemWithAllOptionsInCart(Common.currentUser!!.uid!!,
                ...
                .subscribe(object:SingleObserver<CartItem>{
                    override fun onSuccess(cartItemFromDB: CartItem) {
                        ...
                        {
                            //if item no available in database , just insert
